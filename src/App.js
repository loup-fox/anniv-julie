...
function PhotoCase(props){
  ...
  return open ? (
    <iframe src="https://www.youtube.com/embed/gbWsqgBtELU" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true"/>
  ) : (
